<template>
	<nav
		class="relative top-0 z-30 w-full bg-[#5998ff] start-0 backdrop-blur-2xl 2xl:h-20 xl:h-20 lg:h-20 md:h-16 sm:h-16 h-16"
	>
		<div
			class="flex flex-wrap items-center justify-between max-w-screen-2xl lg:px-4 md:py-3 lg:py-5 mx-auto z-30 bg-transparent relative"
		>
			<div
				class="flex flex-wrap items-center justify-between w-full py-3 relative z-30 md:contents flex-row-reverse md:flex-row"
			>
				<div class="flex flex-row-reverse md:flex-row my-auto">
					<button
						data-drawer-target="separator-sidebar"
						data-drawer-toggle="separator-sidebar"
						aria-controls="separator-sidebar"
						type="button"
						class="inline-flex items-center p-2 ms-3 text-sm text-white rounded-lg sm:hidden my-auto self-center"
					>
					...
					<div
						class="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse content-center my-auto sm:pr-4 z-30 -mr-2"
					>
						<div class="dropdown mx-2 md:mx-auto capitalize">
							<div
								tabindex="0"
								role="button"
								@click="toggleDrop"
								class="mx-1 px-2 py-2 md:px-2 md:py-2 font-medium text-center shine text-white bg-[#4088ff]/90 border border-[#4088ff] rounded-[50px] text-sm md:text-md hover:bg-[#4088ff]/80 flex items-center justify-center"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
								...
								<svg
									...
									v-else-if="locale == 'ar'"
								>
									<rect width="500" height="600" fill="#006233"/>
									<rect x="500" width="500" height="600" fill="#FFFFFF"/>
									<path fill="#CE1126" d="M500,300 m-110,0 a110,110 0 1,0 220,0 a110,110 0 1,0 -220,0"/>
									<path fill="#CE1126" d="M500,300 l-52,-4 l-13,-42 l-52,4 l41,12 l-7,45 l-14,42 l-6,-45 l27,-36 l42,-12 l-14,42 z"/>
								</svg>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									id="flag-icons-fr"
							...
							<ul
								...
								class="dropdown-content z-20 px-2 mt-1 rounded-[20px] font-normal bg-[#4088ff]"
							>
								<li
									v-for="loc in locales.filter((x) => x.value !== locale)"
									:key="loc"
								>
									<a
				...
				<a
					aria-label="Go home"
					:href="localePath('/')"
					class="items-center space-x-3 rtl:space-x-reverse sm:pl-4 pl-2 z-30 flex md:hidden w-1/4 md:w-3/4 lg:w-full"
				>
