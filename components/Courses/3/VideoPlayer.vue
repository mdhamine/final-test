			...
			<div class="grid grid-cols-1 gap-4 h-full">
				...
				>
					<div class="border-gray-400 border-b p-5 pb-0">
						...
						<li class="me-2">
							<a
								:href="localePath(`/courses/3/quiz?id=${active + 1}`)"
						...
						<div class="overflow-auto border-b p-5 pt-12">
							...
							<div class="flex flex-col md:flex-row justify-center md:justify-between w-full px-4 lg:px-60">
								...
								<a
								  ...
								  href="https://t.me/+m3H3BqRvEGU0NjM0"
								>
								    <svg
										class="w-7 h-7 transition duration-200 text-[#000032] group-hover:text-white"
										xmlns="http://www.w3.org/2000/svg"
...
export default {
	...
	data() {
		return {
			...
			classes: {
				author: 'Neserine Athamnia',
				profile: 'https://i.ibb.co/2nFQ5sB/highest-quality-1-1-1-1-1-1-1-1.png',
				position: 'German Instructor',
				en: [
                    {
        title: 'Session 1',
        locked: false,
