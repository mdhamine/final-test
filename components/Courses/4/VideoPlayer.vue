						...
						<div class="overflow-auto border-b p-5 pt-12">
							...
							<div class="flex flex-col md:flex-row justify-center md:justify-between w-full px-4 lg:px-60">
								...
								<a
								  ...
								  href="https://t.me/+FyEXwm5DBt1mODg0"
								>
								    <svg
										class="w-7 h-7 transition duration-200 text-[#000032] group-hover:text-white"
										xmlns="http://www.w3.org/2000/svg"
...
"https://dl.dropbox.com/scl/fi/54brrdirbirpgs4xr0cxq/certfifrench.pdf?rlkey=5l6fvxpka5whg7mgsfml0grjk&st=isw8kkbb&dl=1";
...
export default {
	...
	data() {
		return {
			...
			classes: {
				author: 'Nada Labed',
				profile: 'https://i.ibb.co/khnYRCt/sdlmqjfmlkjsdf.jpg',
    ...
    },
    {
        ...
        locked: true,
        duration: '',
        video: 'https://player.vimeo.com/video/995354464?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479',
        description: '',
    },
    {
        title: 'Session 4',
