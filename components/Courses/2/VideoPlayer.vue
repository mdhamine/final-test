						...
						<div class="overflow-auto border-b p-5 pt-12">
							...
							<div class="flex flex-col md:flex-row justify-center md:justify-between w-full px-4 lg:px-60">
								...
								<a
								  ...
								  type="button"
								  class="flex flex-col items-center justify-center text-[#000032] bg-transparent hover:bg-[#000032] hover:text-white px-4 py-2 m-2 w-full md:w-1/3 btn btn-outline group rounded-3xl"
								  href="https://t.me/+NWRSEZIODrllMDI0"
								>
								    <svg
										class="w-7 h-7 transition duration-200 text-[#000032] group-hover:text-white"
										xmlns="http://www.w3.org/2000/svg"
...
"https://dl.dropbox.com/scl/fi/ne3q1w7o4yf5x72y4bjc9/Certificate-Vintage-Academic-1-1.pdf?rlkey=5s0q38rl1lq88g52pgzar1pva&st=l1yvtdpb&dl=1";
...
export default {
	...
	data() {
		return {
			...
			classes: {
				author: 'Kaouther Boudjema',
				profile: 'https://i.ibb.co/7QC0KYF/IMG-1906-copy-1.jpg',
    ...
    },
    {
        ...
        locked: true,
        duration: '',
        video: 'https://player.vimeo.com/video/994164473?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479',
        description: '',
    },
    {
        title: 'Session 3',
