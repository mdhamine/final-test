			...
			<div class="grid grid-cols-1 gap-4 h-full">
				...
				>
					<div class="border-gray-400 border-b p-5 pb-0">
						...
						<li class="me-2">
							<a
								:href="localePath(`/courses/5/quiz?id=${active + 1}`)"
						...
						<div class="overflow-auto border-b p-5 pt-12">
							...
							<div class="flex flex-col md:flex-row justify-center md:justify-between w-full px-4 lg:px-60">
								...
								<a
								  ...
								  href="https://t.me/+gTmqiAK9jV9mMDg8"
								>
								    <svg
										class="w-7 h-7 transition duration-200 text-[#000032] group-hover:text-white"
										xmlns="http://www.w3.org/2000/svg"
...
const existingPdfUrl = "https://dl.dropbox.com/scl/fi/99hvvmjs6wkuahkwz32xv/Certificate-Vintage-Academic-1.pdf?rlkey=56e14xid60rcw367vo5vyvxrt&st=8pp403m7&dl=1";
...
export default {
	...
	data() {
		return {
			...
			classes: {
				author: 'Sayad Walid',
				profile: 'https://i.ibb.co/hRZKVLY/DSMQLJFMLSKJDFLKJSDF.jpg',
