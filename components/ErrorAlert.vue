			...
			<div class="cOKwvV">
				...
				<div class="dgcJHV">
					<div class="dVKHAC" @click="clearError">
						...
						>
							<path
								d="M13.5355 6.46448L6.46445 13.5355"
								fill="none"
								stroke-width="1.5"
								stroke-linecap="round"
								stroke-linejoin="round"
							...
							></path>
							<path
								d="M13.5355 13.5355L6.46442 6.46445"
								fill="none"
								stroke-width="1.5"
								stroke-linecap="round"
								stroke-linejoin="round"
...
.cOKwvV {
	...
	box-shadow: inset 0 0 0 9999px var(--notification-pale),
		inset 0 0 0 1px var(--notification-light),
		0 2px 6px var(--notification-shadow);
	...
	&::before {
		...
		background-image: linear-gradient(
			...
			var(--notification-transparent) 55%
		);
		opacity: 0.15;
	}
}
